...
const ResponsiveCarousel = () => {
    ...
    return (
        ...
        >
            {products.filter(product => product.stock > 0 && product.category !== categorySelected).map(function getCategories(product) {
                return (
                    <NavLink to={"/products/" + product.product} key={product.id} reloadDocument={true} className="producto">
